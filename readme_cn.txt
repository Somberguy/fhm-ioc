...
找寻项目BUG速度快、自定义`IOC`功能、代码逻辑安全方面都有很好的保障。另外还增加了多项`Spring-Framework`未实现但是有需要的特性，如***IOC仓库规划***功能、
...
（ 在个人看来`Spring-Framework`的`IOC`最大的优势是`Spring-Boot`的体系依赖于它。`Spring-Boot`成功的利用操作系统BIOS程序的思想创建了优秀、完善的框架体系。）
